    ...
    protected void Iniciar() {
        Lector.addDataListener(new DPFPDataAdapter() {
            ...
            public void dataAcquired(final DPFPDataEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        txtArea.setText("La Huella Digital ha sido Capturada");
        ...
        Lector.addReaderStatusListener(new DPFPReaderStatusAdapter() {
            ...
            public void readerDisconnected(final DPFPReaderStatusEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        txtArea.setText("El Sensor de Huella Digital esta Desactivado o no Conectado");
                    }
                });
            }
        });
        ...
        Lector.addSensorListener(new DPFPSensorAdapter() {
            ...
            public void fingerTouched(final DPFPSensorEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        txtArea.setText("El dedo ha sido colocado sobre el Lector de Huella");
                    }
                });
            }
            ...
            public void fingerGone(final DPFPSensorEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        txtArea.setText("El dedo ha sido quitado del Lector de Huella");
                    }
                });
            }
        });
        ...
        Lector.addErrorListener(new DPFPErrorAdapter() {
            public void errorReader(final DPFPErrorEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        txtArea.setText("Error: " + e.getError());
                    }
                });
            }
        });
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblImagenHuella, javax.swing.GroupLayout.DEFAULT_SIZE, 307, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblImagenHuella, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
        );
        ...
        btnVerificar.setFont(new java.awt.Font("Arial Black", 2, 12)); // NOI18N
        ...
        horas.setFont(new java.awt.Font("Arial Black", 2, 12)); // NOI18N
        horas.setText("jLabel1");

        fechas.setFont(new java.awt.Font("Arial Black", 2, 12)); // NOI18N
        fechas.setText("jLabel1");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(fechas, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(fechas, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        ...
        Nombreempleado.setFont(new java.awt.Font("Arial Black", 2, 12)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(267, 267, 267))
            .addComponent(Nombreempleado, javax.swing.GroupLayout.Alignment.TRAILING)
